...
#SBATCH --job-name=dino_512_auxdec1024_unetrcnn_prompts_f0
...
# floating_point_prompts: age/psa/approx_psa_density -- fed into Proside's
# sparse-embedding prompt path (see train_unetr_cnn.py's forward fix).
