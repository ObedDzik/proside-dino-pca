...
#SBATCH --job-name=dino_512_auxdec1024_prompts_f0
...
# Original Proside/mask_decoder path (not the UNETR-CNN variant) -- with
# floating_point_prompts on (age/psa/approx_psa_density). No-prompt baseline
# for this same path/cfg already exists: job 5083409
# (dino_512_auxdec1024_0), no need to rerun it.
srun python -m dino_pca.train -c dino_pca/cfg.yaml \
