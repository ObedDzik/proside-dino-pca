...
class MedSAMIBot(nn.Module):
    def __init__(
        ...
        if medsam_version == 'medsam': 
            ...
            from medAI.modeling.sam import medsam_adapter_256
            medsam_model = medsam_adapter_256()
        else: 
    ...
    def forward(self, image, mask=None, return_all_tokens = True): #return_all_tokens = true replaced with kwargs
...
class ImageEncoderViTWithClassTokenAndMasking(nn.Module):
    ...
    def forward(self, x, mask=None): #put kwargs
